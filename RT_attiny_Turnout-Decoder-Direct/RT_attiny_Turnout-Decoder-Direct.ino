...
//  Serial.print("\nNMRA DCC 8-Turnout Accessory Decoder. Ver: "); Serial.println(DCC_DECODER_VERSION_NUM,DEC);
  Serial.print(F("Rosscoe Train DCC 8 Turnout Accessory Decoder. Ver: ")); Serial.println(DCC_DECODER_VERSION_NUM,DEC);
#endif

#ifdef FORCE_RESET_FACTORY_DEFAULT_CV
#ifdef ENABLE_SERIAL
  Serial.println(F("Resetting CVs to Factory Defaults"));
#endif
 ...
 */
  ...
  if (learningbuttonOldval != learningbuttonVal) {
    ...
    if (learningMode == HIGH) showAcknowledge();
   }
